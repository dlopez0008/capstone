...
This project specifically focuses on daily 500 hPa geopotential height data from 1979 to 2021, concentrating on the grid point closest to New York City. This time frame captures several decades of atmospheric behavior, making it possible to assess long-term variability and emerging trends.
...
To examine the behavior of upper-tropospheric circulation over New York City, we analyzed daily 500 hPa geopotential height data from 1979 to 2021, using the NOAA-CIRES 20th Century Reanalysis II dataset. We extracted data from the grid point closest to NYC’s coordinates (40° N, 75° W) to build a continuous time series of atmospheric heights at the 500 hPa pressure level.
...
Using Python, I loaded each year's data file, spanning from 1979 to 2021, and isolated the grid point closest to NYC’s coordinates at the 500 hPa level.
For every year, I extracted the time series of daily geopotential height values, providing a day by day view of how the geopotential height moved up and down over the city.
