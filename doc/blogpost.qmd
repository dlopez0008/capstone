...
The dataset utilized in this analysis originates from the NCEP/NCAR Reanalysis 1 project, a collaborative effort between NOAA's National Centers for Environmental Prediction (NCEP) and the National Center for Atmospheric Research (NCAR). This reanalysis project employs a consistent data assimilation system to integrate a wide array of historical atmospheric observations—such as those from weather balloons (radiosondes), aircraft, ships, satellites, and surface stations—into a comprehensive global model. By assimilating these diverse data sources using the same model throughout the entire period, the reanalysis provides a coherent and continuous record of atmospheric conditions from 1948 to the present. This project focuses on the Reanalysis II Project dataset which spans from 1979 to present. The reanalysis II dataset builds on its previous model with a more advanced model. 
